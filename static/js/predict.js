...
async function loadModel() {
  ...
  model=await tf.loadModel(`https://raw.githubusercontent.com/PonDad/manatee/master/1_sign_language_digits_classification-master/nodejs/static/sign_language_vgg16/model.json`);
  console.log("model loaded");
  $("#console").html('<li>trained model loaded. </li>');
